...
<head>
    ...
    <link rel="stylesheet" type="text/css"  href="ipva2.css">
    <link rel="stylesheet" href="footer2.css">
    <script defer src="ipva.js"></script>
...
<body>
    ...
    <div class="container" id="ipva-cont">
        <h1>Pernambuco</h1>
        <p>Em <span class="highlight">Pernambuco</span>, haverá desconto de 7% para quem efetuar o pagamento do IPVA 2024 à vista. Outra opção é parcelar o valor a ser pago em dez vezes, mas o valor de cada cota não pode ser inferior a R$ 50.</p>
        <p>A alíquota será de 2,4% sobre o valor do veículo, que pode ser consultado no site da Secretaria da Fazenda do estado.</p>
