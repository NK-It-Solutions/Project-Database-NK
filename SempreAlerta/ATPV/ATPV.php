...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="ATPV.css">
        <script defer src="ATPV.js"></script>
...
<body>
    ...
    <main>
        <p class="my-5 text-center">Uma importante notícia para quem pretende vender o veículo usado.</p>
        <h2 class="my-5 text-center" id="golpe-title">Novo serviço: impressão de ATPV online</h2>
        <p class="my-5 text-center">Agora você <span>não precisa mais comparecer ao NK</span> para obter a <span>Autorização para Transferência de Propriedade do Veículo (ATPV)</span>. </p>
        <p class="my-5 text-center"><span>Em 2025 </span> você poderá imprimir a ATPV online diretamente no site do <span>NK Solutions</span>. </p> 
        <p id="textobugadodokrlvsf">Caso o proprietário possua algum impedimento para realização do serviço online, ele não precisa se <br> preocupar. Continuará disponível a opção de agendamento para obter a ATPV presencialmente em <br> qualquer unidade do NK Solutions. </p>    
   </main>
